...
|고객|## 김민준 (7세, 남, 경기 거주)
<br>
**특징**<br>- 자폐 스펙트럼 장애 진단, 최소 언어 수준(무발화)<br>- 단어에 대한 이해도는 있으나 발음이나 문장으로 표현하기 어려움<br>- 감정이나 요구를 주로 행동(손짓, 울음)으로 전달<br>- 공룡, 음식, 가족 등 구체적인 사물에 관심 많음<br>
**고민**<br>- “먹고 싶다”, “가기 싫다” 같은 기본적인 표현을 말로 전달하지 못함<br>- 기존 PECS 카드에는 원하는 단어가 없어 표현할 방법이 제한적<br>  - 말을 대신할 수 있는 도구가 있어도 그림이 낯설면 잘 사용하지 않음 <br>
**상황**<br>- 가정과 학교에서 부모, 교사와 함께 태블릿으로 학습·놀이 병행<br>- 익숙한 그림, 직접 고른 이미지에는 높은 반응 보임<br>  - 간단한 단어 선택만으로도 자신이 원하는 걸 표현하고 싶어함<br>  
<hr>
## 이지현 (38세, 여, 서울 거주)<br>**특징**<br>
- 김민준의 어머니, 전업주부<br>- 아들의 행동을 통해 욕구를 유추하지만 오해가 자주 발생<br>- 기존 PECS 키트(10만 원 상당)를 사용했지만 단어 추가가 어렵고 관리가 번거로움<br>- 디지털 기기 사용에는 익숙하지만 아동용 전문 앱은 생소함<br>**고민**<br>- 아이가 어떤 단어·문장을 자주 사용하는지 데이터로 보고 싶음<br>- 아이가 좋아하는 주제(공룡, 음식 등)에 맞는 맞춤형 그림 카드가 부족함<br>- 아이의 의사 표현의 진전 정도를 객관적으로 알 수 없음<br>**상황**<br><br>- 스마트폰·태블릿으로 아이의 앱 사용을 함께 관찰<br>- 아이가 선택한 단어·문장 기록이 자동 통계로 정리되는 시스템을 원함<br>- 아이가 흥미를 느끼며 꾸준히 사용할 수 있는 ‘놀이형 의사소통 도구’ 필요|
